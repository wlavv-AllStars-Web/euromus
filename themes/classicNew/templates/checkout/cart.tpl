  ...
  <section id="main">
    <div class="cart-grid row">
      ...
      {block name='continue_shopping'}
        <a class="label" href="{$urls.pages.index}" style="margin-left: 4rem;font-size:1.1rem;color:#ee302e;" onMouseOver="this.style.color='#103054'" onMouseOut="this.style.color='#ee302e'">
