...
<script>
    ...
    $(document).on("click","#uploadSubmitButton", function(){
		...
		$.ajax({
			type : 'POST',
			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=uploadSubmitButton",
			data : dataForm,
            processData: false,
            contentType: false,
    ...
    function setModal(id_image, type, selectElement, element){
		...
		$.ajax({
			type : 'POST',
			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=getBrandImages",
			data : {
    ...
    function setImage(id_zone, id_image, url, homepage_manufacturer_id, homepage_manufacturer_id_manufacturer){
		...
		$.ajax({
			type : 'POST',
			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=updateHomepageTemp",
			data : {
				'id_zone' : id_zone,
				'id_image' : id_image,
				'url' : url,
    ...
    function saveDesktopLive(){
        ...
        if (resposta) {
    		$.ajax({
    			type : 'POST',
    			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=setDesktopLive",
    			data : { },
    ...
    function saveMobileLive(){
        ...
        if (resposta) {
    		$.ajax({
    			type : 'POST',
    			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=setMobileLive",
    			data : { },
    ...
    function saveVideoCode(element, position){
	    ...
	    $.ajax({
			type : 'POST',
			url : "https://www.all-stars-motorsport.com/admin77500/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}&action=updateVideoCode",
			data : {
				'position' : position,
				'code' : element.value
			},
