<div id="_desktop_user_info">
  <div class="user-info">
    {if $logged}
      <a class="logout d-none d-lg-block" href="{$logout_url}" rel="nofollow" >
    ...
    {else}
      <a class="user-info-account" href="{$my_account_url}" style="display: flex;justify-content:end;align-items:center;padding-right:4px;gap:5px;" title="{l s='Log in to your customer account' d='Shop.Theme.CustomerAccount'}" rel="nofollow" >
        <i class="fa-solid fa-user" style="color:#fff"></i>
        <span class="d-none d-lg-block" style="text-transform: uppercase;color:#fff;font-weight:600;font-size:15px;">{l s='My account' d='Shop.Theme.Actions'}</span>
      </a>
