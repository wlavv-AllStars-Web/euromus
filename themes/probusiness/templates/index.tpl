            ...
            {else} *}
              <div class="not_logged_homepage">
                ...
                <div class="profile_container_homepage">
                  ...
                  <div id="profile_container_text1 " class="card_view_more mobile" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                </div>
                ...
                <div id="why_us_anchor">
                  <div class="why_card">
                    ...
                    <div id="card_expand1" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="card_expand2" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="card_expand3" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="card_expand4" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="card_expand5" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="card_expand6" class="card_view_more" onclick="viewMore(this)">{l s='View More' d='Shop.Theme.HomepageLogout'}</div>
                  </div>
