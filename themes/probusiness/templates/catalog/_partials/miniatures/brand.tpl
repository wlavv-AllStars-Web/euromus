  ...
  {if Context::getContext()->customer->logged}
    <li class="brand_logged col-md-3 col-xs-6" style="margin-top: 2rem;">
      <div class="brand_content_item_logged" style="border: 1px solid #0273eb;">
          ...
          <div class="brand-img" >
            <a href="{$brand.url|escape:'html':'UTF-8'}" style="display:flex;justify-content:center;align-items:center;"><img src="{$brand.image_h|escape:'html':'UTF-8'}" alt="{$brand.name|escape:'html':'UTF-8'}" style="width: 100%;max-width:150px;"></a>
          </div>
