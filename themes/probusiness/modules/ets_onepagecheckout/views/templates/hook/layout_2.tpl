        ...
        <div class="onepagecheckout-left col-lg-12">
            ...
            <div class="block-onepagecheckout block-address">
                ...
                <div class="col-lg-6 invoice-address-container  px-0">
                    ...
                    {/if}
                    <div id="invoice-addresses" class="address-selector js-address-selector col-lg-12" style="display:none">
            ...
            {if Configuration::get('PS_CONDITIONS')}
                <div id="conditions-to-approve" method="GET">
                    <ul>
                        <li style="max-width: 600px;margin: auto;gap: 1rem;text-align: center;">
                            ...
                            <div class="condition-label">
                                <label class="js-terms required" for="conditions_to_approve" onclick="checkCheckboxTerms()" >
                                    {l s='I declare that I have read and accept the privacy policies in force. To view the privacy policies, please click on:' mod='ets_onepagecheckout'}
                                    <a href="{$link->getCMSLink(7)}" id="cta-terms-and-conditions-0">{l s='Privacy policies' mod='ets_onepagecheckout'}</a>
                                </label>
                            </div>
                        </li>
                    </ul>
