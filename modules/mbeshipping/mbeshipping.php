...
class Mbeshipping extends CarrierModule
{
    ...
    private function getTabName($tab_class_name, $lang_iso_code)
    {
        $tab_name_lang = [
            ...
            'AdminMbePickupAddressHelper' => [
                'de' => 'MBE - Pickup address',
                'en' => 'MBE - Pickup address',
                'es' => 'MBE - Pickup address',
                'fr' => 'MBE - Pickup address',
                'it' => 'MBE - Pickup address',
                'pl' => 'MBE - Pickup address',
            ]
        ];
...
//                'banner_packing' => $links['banner_packing'],
    ...
    public function getFormTabPickupManagement()
    {
        ...
        $disable_section = !($shipments_creation_mode == 'automatically');
        ...
        if ($disable_section) {
            $form_inputs[] = [
                'type' => 'alert',
                'alert' => 'warning',
                'text' => "{$this->l("These settings are only available when")} \"{$this->l('Creating shipments - Methods')}\" {$this->l("is set to")} \"{$this->l('Automatically')}\"",
            ];
        }
        ...
        $form_inputs[] = [
            ...
            'disabled' => $disable_section || $this->is_direct_channel_user,
        ...
        $form_inputs[] = [
            ...
            'required' => true,
            //'disabled' => true,
            'desc' => $this->l('By choosing Morning, pickup requests will be automatically routed to couriers for same-day pickup, for all shipments created by 10 a.m. By choosing Evening, pickup requests will be automatically routed to couriers for next-day pickup, for all shipments created by 10 p.m.'),
        ];
