<div>
    <form name="form_homepage"  action="/admineuromus1/index.php?controller=AdminWmModuleHomepage&token={Tools::getAdminTokenLite('AdminWmModuleHomepage')}" enctype="multipart/form-data" method="POST">
            ...
            <div class="panel-body" style="padding: 15px 0;">
                <div>
                    <div style="width: 60%; float: left;">
                        <img onclick="$('#homepage_banner').click();" src="/img/media_images/Homepage/main.webp?updated={rand()}" style="width: 100%;cursor:pointer;">
            ...
            <div class="panel-body" style="padding: 15px 0;">
                <div>
                    <div style="width: 20%; float: left; text-align: center;">    
                        <img onclick="$('#footer_banner').click();" src="/img/media_images/Events/main_250x100.webp?updated={rand()}" style="margin: 15px auto;cursor:pointer;">
