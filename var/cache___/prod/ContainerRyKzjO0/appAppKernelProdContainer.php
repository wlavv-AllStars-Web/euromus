...
class appAppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'PrestaShop\\Module\\WkDemo\\Form\\Modifier\\ProductFormModifier' => 'getProductFormModifierService.php',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('5Ow8IJFjV8', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        ...
        $g = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($d, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('GP5uER9sK2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5Yh+I9ELMx', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('zUvkSlh803', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f7RT64AF31', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wKfVp5JOeY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V7wapSJmef', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f0agn72lNk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('k53OlQ9094', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BypWiAj3ev', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_access'] = \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('njn64cUgW5', 0, $this->getParameter('container.build_id'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.property_info'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dOdfK+X4Bg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jyLaI-NRap', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ni4qNr9QSX', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    {
        return $this->privates['cache.validator'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+JqFJb20ph', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                68 => 'ps_imageslider',
                69 => 'autoupgrade',
                70 => 'ps_languageselector',
                71 => 'youtube_video',
                72 => 'wmmodule_homepage',
                73 => 'ukoocompat',
                74 => 'alma',
                75 => 'wkdemo',
                76 => 'ps_shoppingcart',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDr/WeVaqGhrB/A'."\n".'IxZqbOnNAy2fitMmP/PMHXz6m1SeB6PBlOmIXRXLYnfGQOZ7HqvG9wVBvWEpWMZA'."\n".'7dqkVf1RRsGMfHGKEmD1Nwe2eChX0kzeiGJszVM4asZ0xsKqLs4DARiGSFX64E2l'."\n".'avBYQYt36riQuimzR/RTjcSPXG9eWBdf5RO4c2Lp/5GFENM4i63cH6Qvgha3++83'."\n".'eqhOznRsZtJxywq6iGUvzkeQVDNu5qpBGu2ArMm4zi6L8rRmUJWkxdvFnInJtWiU'."\n".'x/zU6eGyd7x1kCrl5qe4OAQ6GGwuy5pHMgfez/zZ+HT/2jZ0igFQUJ3z82sVCTph'."\n".'vjcfdIvbAgMBAAECggEAUflDOv7ASHWOzeIiTjOo/0LkXTAO6pF6cWOo3zCHsyE6'."\n".'O+srN+gFwxFgQ6iVpxzfVIzH8a8ECiXBMBqvQThxdwMaBl/P3MNHlMZZ0oNomCD/'."\n".'/Kjpb5vfFZDZgQTt58m8XATMbRDBdRTnQ9eixzV1aeFJ3VQdWh5be46aQaY9NUq/'."\n".'cYJf39aaCi0K2u3U6vjPovLO9B/m6VsTZNcq19jIJK83bQug6YY9XMtClARNX0no'."\n".'NQK1kHRWQocxUp7wydLSlFXqEj5gQXkFraY0fn4Z4+eFA4n+enIBwzpHdwChWGk8'."\n".'f0y+ss19JYmqJNGaJV829nfD7DU1JyJ707EJ+jPIEQKBgQD+EOLeYXiPlFZD3+Bc'."\n".'Rhv9dhLazw6tPQRIStBkAqhDLgNVMEXTPZBYPgIWw10KFdNMXjKAedOaQX1f9ZUx'."\n".'JyeUb8B41gFFI0/KYA+vi5zTeIQOqLznWFbROJb6r2ivdLZlEdZpCe13aFNhBuso'."\n".'uegTx15sS24ayeqHI5V/7CXf4wKBgQDtyUrcMhQYXGhZk68Q+f8GxthCwnd+YeyW'."\n".'5pvalHX9RhZvXXEiEGegxnk9qYWDBdiGjOeQlSi/1c4aqgTn9msiTOOrG1LGbx99'."\n".'iryeVbhr9Mb35/uOQxQdSQhRX67pkqOQRGEByMtEOH+Ijv6Ps/AAHaVq7lpRlTJv'."\n".'qAkNcCt1qQKBgDIsB4E+4l4IPxjcRyQxvClLfeGz7gQL/qKAE7MMS0oo9gOGquNS'."\n".'TwT+Cc+Q+Pia4sU7/OEeLclSkX23s6SnRMutXeb+6/VJSeJ/IdnayjeAnyN98wAE'."\n".'k/BxKm+K4DN16ub+pMbNbRWdhomsohfCzq/JOT5Njwq/QQ862bUPX1NdAoGBAI32'."\n".'qonyIAs3SFmKkW+KQdby6nRZE+xRXGXvQkdqcVMIACb2269hqezT8dh9mCdUWyRh'."\n".'hXLNiqmVZVqH/Svb87RjwV0LkAzGlT9nkBrbxKI3Xn7tckNKCv08+AlVHeF3Wc2s'."\n".'9VmSXsDZFlMaRCLZY8U97d98dFHWyGjfIqByQpAZAoGAEk9Ys9RbZKOfsijWMDDK'."\n".'TJbKSiYk7QxGn27ib3lazXvaP2WSxjrVmmgKfEf8ubdW5cPmIbaE819LFdW888Yj'."\n".'S7a4rgTgh/I3+WbTjxxTkTkWL5urPTUWB5jCU51MRVUm44upGl9LJqJH8R1yEzuI'."\n".'Vz+If/CPFizvq0ePt9IqzpY='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                8 => (\dirname(__DIR__, 4).'/modules/ps_featuredproducts/translations'),
                9 => (\dirname(__DIR__, 4).'/modules/ps_banner/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/ps_customtext/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_specials/translations'),
                12 => (\dirname(__DIR__, 4).'/modules/ps_newproducts/translations'),
                13 => (\dirname(__DIR__, 4).'/modules/ps_bestsellers/translations'),
                14 => (\dirname(__DIR__, 4).'/modules/ps_emailsubscription/translations'),
                15 => (\dirname(__DIR__, 4).'/modules/ps_socialfollow/translations'),
                16 => (\dirname(__DIR__, 4).'/modules/ps_customeraccountlinks/translations'),
                17 => (\dirname(__DIR__, 4).'/modules/productcomments/translations'),
                18 => (\dirname(__DIR__, 4).'/modules/ps_categorytree/translations'),
                19 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                ...
                28 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/statsbestsuppliers/translations'),
                37 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                ...
                43 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                48 => (\dirname(__DIR__, 4).'/modules/dashtrends/translations'),
                49 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
                50 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                51 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                ...
                59 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                60 => (\dirname(__DIR__, 4).'/modules/ps_imageslider/translations'),
                61 => (\dirname(__DIR__, 4).'/modules/autoupgrade/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_languageselector/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/wmmodule_homepage/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ukoocompat/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/alma/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/ps_shoppingcart/translations'),
            ],
