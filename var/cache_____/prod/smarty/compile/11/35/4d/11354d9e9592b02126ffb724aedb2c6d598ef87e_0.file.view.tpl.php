...
/* Smarty version 4.3.4, created on 2024-06-17 09:45:26
  from 'C:\xampp\htdocs\euromus\modules\wmmodule_homepage\views\templates\admin\view.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_666ff7a6274d84_02646732',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '11354d9e9592b02126ffb724aedb2c6d598ef87e' => 
    array (
      0 => 'C:\\xampp\\htdocs\\euromus\\modules\\wmmodule_homepage\\views\\templates\\admin\\view.tpl',
      1 => 1718190406,
      2 => 'file',
    ),
  ),
...
function content_666ff7a6274d84_02646732 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_assignInScope('currentShop', Context::getContext()->shop->id);
if ($_smarty_tpl->tpl_vars['banners']->value[5]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[5]['image_en']);?>
   <?php }
if ($_smarty_tpl->tpl_vars['banners']->value[4]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[4]['image_en']);?>
   <?php }
if ($_smarty_tpl->tpl_vars['banners']->value[3]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[3]['image_en']);?>
   <?php }?>
   <?php if ($_smarty_tpl->tpl_vars['banners']->value[2]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[2]['image_en']);?>
   <?php }
if ($_smarty_tpl->tpl_vars['banners']->value[1]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[1]['image_en']);?>
   <?php }
if ($_smarty_tpl->tpl_vars['banners']->value[0]['active'] == '1') {?>
   <?php $_smarty_tpl->_assignInScope('bb', $_smarty_tpl->tpl_vars['banners']->value[0]['image_en']);?>
   <?php }
if ($_smarty_tpl->tpl_vars['currentShop']->value == 1) {?>
    <h1 style="text-transform: uppercase;font-weight:bold;color:dodgerblue;">Euromuscle</h1>
<?php } elseif ($_smarty_tpl->tpl_vars['currentShop']->value == 2) {?>
    <h1 style="text-transform: uppercase;font-weight:bold;color:#ee302e;">All Stars Motorsport</h1>
<?php } elseif ($_smarty_tpl->tpl_vars['currentShop']->value == 3) {?>
...
<div id="desktop_layer_container" style="display: block;padding:0 10px;background-color: #ddd;border: 1px solid #777;">
    <?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['modules']->value)."/wmmodule_homepage/views/templates/admin/desktop.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
</div>

<div id="mobile_layer_container"  style="display: none;padding:0 10px;background-color: #ddd;border: 1px solid #777;">
    <?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['modules']->value)."/wmmodule_homepage/views/templates/admin/mobile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
</div>
...
>
    ...
    $(document).on("click","#uploadSubmitButton", function(){
		...
		$.ajax({
			type : 'POST',
			url : "<?php echo $_smarty_tpl->tpl_vars['httpssl']->value;?>
//<?php echo $_smarty_tpl->tpl_vars['dominio']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['back_path']->value;?>
/index.php?controller=AdminWmModuleHomepage&token=<?php echo Tools::getAdminTokenLite('AdminWmModuleHomepage');?>
&action=uploadSubmitButton",
			data : dataForm,
            processData: false,
            contentType: false,
...
&action=deleteImgButton",
    ...
    function setIdToZero(element,id_element) {
        ...
        setImageText(element, id_element, `select_car_<?php echo $_smarty_tpl->tpl_vars['id_element']->value;?>
`)
    }
