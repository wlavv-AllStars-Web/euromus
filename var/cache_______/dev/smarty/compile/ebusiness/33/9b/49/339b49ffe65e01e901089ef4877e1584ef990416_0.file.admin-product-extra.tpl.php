<?php
/* Smarty version 4.3.4, created on 2024-06-18 16:13:05
  from 'C:\xampp\htdocs\euromus\themes\ebusiness\modules\ukoocompat\views\templates\hook\admin-product-extra.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_6671a4019b3126_21238377',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '339b49ffe65e01e901089ef4877e1584ef990416' => 
    array (
      0 => 'C:\\xampp\\htdocs\\euromus\\themes\\ebusiness\\modules\\ukoocompat\\views\\templates\\hook\\admin-product-extra.tpl',
      1 => 1718723501,
      2 => 'file',
    ),
  ),
...
function content_6671a4019b3126_21238377 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ((isset($_smarty_tpl->tpl_vars['id_product']->value)) && call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['id_product']->value )) != 0) {?>
...
?>
    <div class="panel product-tab">
        <h3><i class="icon-search"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Search:','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
...
?>
                        ...
                        <td>
                            <?php if ($_smarty_tpl->tpl_vars['compat']->value[('filter_').($_smarty_tpl->tpl_vars['filter']->value->id_ukoocompat_filter)] == '*') {?>
                                <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
                        ...
                        <div class="btn-group-action">
                            <div class="btn-group pull-right">
                                ...
                                <a href="javascript:void(0);"
                                   onclick="if (confirm('<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete the compatibility:','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
 <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['tab']->value['search']->filters, 'filter');
$_smarty_tpl->tpl_vars['filter']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['filter']->value) {
...
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
...
);}else{event.stopPropagation(); event.preventDefault();};" class="edit btn btn-default" title="<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
">
                                    <i class="icon-trash"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Delete','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    ...
    <div class="panel product-tab" style="display: none;">
		<div onclick="$('#container_new_compatibility').toggle()" style="cursor:pointer;">
			<h3><i class="icon-check"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Create new compatibility','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</h3>
		</div>

		<div id="container_new_compatibility" style="display:blobk;">
			<!--<div class="alert alert-info">
				<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Indicate the combination of criteria with which there is compatible.','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
...
">
								<option value="" ><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'---','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</option>
								<option value="*"<?php if ((isset($_smarty_tpl->tpl_vars['selected_criteria']->value[call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['filter']->value['id'] ))])) && $_smarty_tpl->tpl_vars['selected_criteria']->value[call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'intval' ][ 0 ], array( $_smarty_tpl->tpl_vars['filter']->value['id'] ))]['id_ukoocompat_criterion'] == '*') {?> selected="selected"<?php }?>><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</option>
								<?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
			...
			<div class="panel-footer">
								<button type="submit" name="submitAddproduct" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</button>
				<button type="submit" name="submitAddproductAndStay" class="btn btn-default pull-right"><i class="process-icon-save"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Save and stay','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</button>
			</div>
		</siv>
...
<?php } else { ?>
    <div class="alert alert-warning">
        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'There is a warning','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>

        <ul style="display:block;" id="seeMore">
            <li><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'You must register the product before creating its compatibility.','d'=>'Modules.Ukoocompat.AdminProductExtra'),$_smarty_tpl ) );?>
</li>
        </ul>
    </div>
<?php }
