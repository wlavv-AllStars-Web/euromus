...
class appAppKernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $e->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_accounts'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);
        $f = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'ps_checkout'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
