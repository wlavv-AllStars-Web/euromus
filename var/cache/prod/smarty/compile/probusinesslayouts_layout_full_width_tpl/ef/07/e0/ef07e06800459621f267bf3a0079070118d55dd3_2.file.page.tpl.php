<?php
/* Smarty version 4.3.4, created on 2024-06-21 15:08:02
  from 'C:\xampp\htdocs\euromus\themes\probusiness\templates\cms\page.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66758942ae0db2_44374640',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'ef07e06800459621f267bf3a0079070118d55dd3' => 
    array (
      0 => 'C:\\xampp\\htdocs\\euromus\\themes\\probusiness\\templates\\cms\\page.tpl',
      1 => 1717771092,
      2 => 'file',
    ),
  ),
...
function content_66758942ae0db2_44374640 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_66760653766758942aa0166_38869482', 'page_title');
?>


<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_170839165866758942aa46b1_77250081', 'page_content_container');
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, 'page.tpl');
}
/* {block 'page_title'} */
class Block_66760653766758942aa0166_38869482 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page_title' => 
  array (
    0 => 'Block_66760653766758942aa0166_38869482',
  ),
);
...
/* {/block 'page_title'} */
/* {block 'cms_content'} */
class Block_51039476866758942aa5286_89432486 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
      ...
      <?php } elseif ($_smarty_tpl->tpl_vars['cms']->value['id'] === 14) {?>
        ...
        <?php echo '<script'; ?>
 src="https://cdn.jsdelivr.net/npm/signature_pad@4.1.7/dist/signature_pad.umd.min.js"><?php echo '</script'; ?>
>
        <?php echo '<script'; ?>
>
      ...
      <?php } elseif ($_smarty_tpl->tpl_vars['cms']->value['id'] === 7) {?>
        <div class="cms-privacy">
          ...
          <div class="privacy-content">
            <h1><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Privacy policy','d'=>'Shop.Theme.Privacy'),$_smarty_tpl ) );?>
</h1>
            ...
            <ul class="contents-list">
                <li>  <a href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['link']->value->getCMSLink(7), ENT_QUOTES, 'UTF-8');?>
#Collection"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Collection of personal information','d'=>'Shop.Theme.Privacy'),$_smarty_tpl ) );?>
</a></li>
                <li>  <a href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['link']->value->getCMSLink(7), ENT_QUOTES, 'UTF-8');?>
#children"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Privacy of children','d'=>'Shop.Theme.Privacy'),$_smarty_tpl ) );?>
</a></li>
                <li>  <a href="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['link']->value->getCMSLink(7), ENT_QUOTES, 'UTF-8');?>
#collected"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Use and processing of collected information','d'=>'Shop.Theme.Privacy'),$_smarty_tpl ) );?>
</a></li>
...
<br>
            ...
            <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'This document was last updated on August 25, 2022','d'=>'Shop.Theme.Privacy'),$_smarty_tpl ) );?>
</p>
        ...
        <div class="banner_cms_partners" style="margin-bottom: 3rem;">
          ...
          <div class="rte">
            ...
            <div class="row cards">
              ...
              <div class="text_partners"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'','d'=>'Shop.Theme.Partners'),$_smarty_tpl ) );?>
DPD group is the largest parcel delivery network in Europe, carrying worldwide about 5.3 million parcels daily via 77000 workers through their 4 different brands DPD, Chronopost, SEUR and BRT.​</div>
      ...
      <?php } elseif ($_smarty_tpl->tpl_vars['cms']->value['id'] === 11) {?>
        <div class="rte">
          ...
          <p class="cms_title_center" style="color: black; font-weight: bolder; font-size: 23px;"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'','d'=>'Shop.Theme.Payment'),$_smarty_tpl ) );?>
ALL STARS DISTRIBUTION offers two methods of payment :</p>
          <div class="spacer-20"></div>
            ...
            <div id="why_us_anchor">
                  <div class="why_card">
                    ...
                    <div id="thumb_data_1" class="card_text text-career" >
                      <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Full Time - Valenca, PT','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                      <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The graphic designer creates visual communications to convey messages in an effective and aesthetically pleasing manner.
                      This incorporates several tasks and responsibilities such as illustrations, banners, logos and marketing contents creation.
                      The graphic designer, with a strong creative presence and artistic flair, shapes the visual aspect of our websites; products, marketing supports, exhibitions and more ! ','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>

                      <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- REQUIREMENTS -','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- High school graphic diploma or strong portfolio','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- 2 years working experience as graphic designer in company','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Fluency with design softwares like Lightroom, Illustrator, Dreamweaver, Photoshop','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Familiar with video edition softwares such as Premiere, AfterFX, Finalcut...','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Foreign language spoken / written English or french','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Ability to work harmoniously with diverse range of people','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Knowledge in the automotive industry appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                    </div>
                    <div id="card_expand1" class="card_view_more" onclick="viewMore(this)"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View More','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <div id="thumb_data_2" class="card_text text-career">
                      ...
                      <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The web programmers or web developers use a variety of programming languages to create web applications, online tools and resources mainly database-driven.
                      ...
                      They develop our back office programs and interfaces using the best practices and are responsibile for maintaining, expanding, and scaling our sites while staying plugged into emerging technologies / industry trends. ','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>

                      <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- REQUIREMENTS -','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- High School IT / coding / web design diploma','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- 3 years working experience as web developer / programmer in company','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Top-notch programming skills and in-depth knowledge of HTML, CSS, JavaScript, PHP,and other coding languages','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Fluency in one of these languages : English or French','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Knowledge of relational database systems, Object Oriented Programming and web applications development','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Knowledge of Search Engine Optimization process','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Aggressive problem diagnosis and creative problem solving skills','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Proficient organizational skills, detail-oriented, multitasking, good under pressure','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                    </div>
                  ...
                  <div class="why_card">
                    ...
                    <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Full Time - Valenca, PT','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
                        ...
                        <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The customer service representative helps customers, giving them precious information about products or services, following their orders and return / warranty processes.
                        The representative schedule is splitted between answering customers questions via e-mail and working closely with the purchase and marketing departments to elaborate products descriptions and online resources in various languages.','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
  
                      <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- REQUIREMENTS -','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Absolute fluency in one of these languages (French, Spanish, English, German)','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- High school diploma, general education degree or equivalent.','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Proficient with using computers and basic office softwares','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Excellent proofreading skills to identify grammar, spelling or punctuation errors','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Ability to stay calm, organized and focused','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Knowledge in the automotive industry appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                    </div>
                  ...
                  <div class="why_card">
                    ...
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The Picker is part of the order preparation process, using various digital and mechanical tools to pick a wide variety of items and bring them to the preparation area.
                    ...
                    The picker will operate a drivable vertical mast lift, a forklift and will perform duties up to 30kgs. ','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>

                      <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- REQUIREMENTS -','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Proficient with using computers / electronic devices','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Excellent verbal and written communication skills','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Ability to work harmoniously with diverse range of people','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Physically agile and dexterous','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Proficient organizational skills','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Forklift licence appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Foreign language spoken highly appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                    </div>
                  ...
                  <div class="why_card">
                    ...
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'The warehouse associate uses various digital and mechanical tools to pack and ship the orders accurately.
                    ...
                    The warehouse associate may operate a drivable vertical mast lift, a forklift and perform duties up to 30kgs.','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
                      ...
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Warehouse experience or high school diploma required','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Forklift licence appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</p>
                      <p><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'- Foreign language spoken highly appreciated','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
                    ...
                    <div id="card_expand5" class="card_view_more" onclick="viewMore(this)"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View More','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</div>
                  </div>
                  ...
                  <div class="why_card">
                    ...
                    <b><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'General application','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</b>
                    <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No open position matching with your skills at the moment ?
                    No problem, apply anyway, maybe we can find something for you...','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>

                    </div>
                    <div id="card_expand6" class="card_view_more" onclick="viewMore(this)"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'View More','d'=>'Shop.Theme.Career'),$_smarty_tpl ) );?>
</div>
                  </div>
...
class Block_108937302966758942adf391_51013135 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_127257005966758942ae02d7_39879366 extends Smarty_Internal_Block
{
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
class Block_170839165866758942aa46b1_77250081 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page_content_container' => 
  array (
    0 => 'Block_170839165866758942aa46b1_77250081',
  ),
  'cms_content' => 
  array (
    0 => 'Block_51039476866758942aa5286_89432486',
  ),
  'hook_cms_dispute_information' => 
  array (
    0 => 'Block_108937302966758942adf391_51013135',
  ),
  'hook_cms_print_button' => 
  array (
    0 => 'Block_127257005966758942ae02d7_39879366',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
...
">
    ...
    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_51039476866758942aa5286_89432486', 'cms_content', $this->tplIndex);
?>


    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_108937302966758942adf391_51013135', 'hook_cms_dispute_information', $this->tplIndex);
?>


    <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_127257005966758942ae02d7_39879366', 'hook_cms_print_button', $this->tplIndex);
?>
