<?php
/* Smarty version 4.3.4, created on 2024-06-21 15:56:25
  from 'C:\xampp\htdocs\euromus\themes\probusiness\templates\customer\_partials\order-detail-no-return.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66759499e36ae8_26306749',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '33b60b964bce99f91697cfe509f27b84bd4d7767' => 
    array (
      0 => 'C:\\xampp\\htdocs\\euromus\\themes\\probusiness\\templates\\customer\\_partials\\order-detail-no-return.tpl',
      1 => 1702297383,
      2 => 'file',
    ),
  ),
...
function content_66759499e36ae8_26306749 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, false);
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_123935156466759499e13d60_75863699', 'order_products_table');
?>

<?php }
/* {block 'order_products_table'} */
class Block_123935156466759499e13d60_75863699 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'order_products_table' => 
  array (
    0 => 'Block_123935156466759499e13d60_75863699',
  ),
);
...
?>
        <tr>
          <td>
            <strong>
              <a <?php if ((isset($_smarty_tpl->tpl_vars['product']->value['download_link']))) {?>href="<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['download_link'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
"<?php }?>>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <td class="text-xs-right"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['price'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</td>
          <td class="text-xs-right"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['product']->value['total'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</td>
        </tr>
      <?php
}
...
?>
          <?php if ($_smarty_tpl->tpl_vars['line']->value['value']) {?>
            <tr class="text-xs-right line-<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['line']->value['type'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
              <td colspan="3"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['line']->value['label'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</td>
              <td><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['line']->value['value'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</td>
            </tr>
          <?php }?>
        <?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
        <tr class="text-xs-right line-<?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['order']->value['totals']['total']['type'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
">
          <td colspan="3"><?php echo htmlspecialchars((string) call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['order']->value['totals']['total']['label'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</td>
