...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_667581507964c7_99934301',
...
function content_667581507964c7_99934301 (Smarty_Internal_Template $_smarty_tpl) {
...
.png" style="margin: 0 auto;max-width: 300px; position: relative; top: -5px;pointer-events: none;">
        ...
        <div class="current-car-content">
          ...
          onclick="addToMyCars(<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['filter_1']->value, ENT_QUOTES, 'UTF-8');?>
,<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['filter_2']->value, ENT_QUOTES, 'UTF-8');?>
,<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['filter_3']->value, ENT_QUOTES, 'UTF-8');?>
,<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['filter_4']->value, ENT_QUOTES, 'UTF-8');?>
,<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customer']->value['is_logged'], ENT_QUOTES, 'UTF-8');?>
,'<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['ukoo_name_1']->value, ENT_QUOTES, 'UTF-8');?>
', '<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['ukoo_name_2']->value, ENT_QUOTES, 'UTF-8');?>
', '<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['ukoo_name_3']->value, ENT_QUOTES, 'UTF-8');?>
...
?>
                <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_65069793966758150791a19_69826766', 'product_miniature');
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
  ...
  <?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_162837963667581507927a0_26003770', 'pagination');
?>
...
function addToMyCars(id_brand, id_model, id_type, id_version, logged, brand, model, type, version){
        ...
        if(logged == 1){
            id_customer = <?php echo htmlspecialchars((string) intval($_smarty_tpl->tpl_vars['customer']->value['id']), ENT_QUOTES, 'UTF-8');?>
;
            email = "<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['customer']->value['email'], ENT_QUOTES, 'UTF-8');?>
";
        } else {
...
");
        ...
        // alert("<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['_SERVER']->value['DOCUMENT_ROOT'], ENT_QUOTES, 'UTF-8');?>
/js/asm/front/carNewsletter/carNewsletter.php")
        
        if(email.length > 0){
            $.ajax({
                url: "<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['_SERVER']->value['DOCUMENT_ROOT'], ENT_QUOTES, 'UTF-8');?>
/asm/front/carNewsletter/carNewsletter.php",
                type: 'POST',
                data: {
                    'id_brand': id_brand,
                    'id_model': id_model,
...
class Block_65069793966758150791a19_69826766 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'product_miniature' => 
  array (
    0 => 'Block_65069793966758150791a19_69826766',
  ),
);
...
/* {/block 'product_miniature'} */
/* {block 'pagination'} */
class Block_162837963667581507927a0_26003770 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'pagination' => 
  array (
    0 => 'Block_162837963667581507927a0_26003770',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
