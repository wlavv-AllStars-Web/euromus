...
class __TwigTemplate_fd68231dc618fcd06e55772629bcf046 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@MailThemes\\modern\\core\\download_product.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@MailThemes\\modern\\core\\download_product.html.twig"));
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Download products", [], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 3, $this->source); })())), "html", null, true);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Thank you for your order with the reference {order_name} from [1]{shop_name}[/1]", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 30, $this->source); })()));
        echo "</div>
                                        </td>
                                      </tr>
                                      <!-- H2 TITLE ENDING -->
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Product(s) to download", [], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 95, $this->source); })()));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("You have [1]{nbProducts}[/1] product(s) now available for download using the following link(s):", ["[1]" => "<span class=\"label\">", "[/1]" => "</span>"], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 130, $this->source); })()));
        echo "</div>
                                        </td>
                                      </tr>
                                      <tr>
        ...
        echo ";color:#363A41;\">
                                            ";
        // line 136
        if (((isset($context["templateType"]) || array_key_exists("templateType", $context) ? $context["templateType"] : (function () { throw new RuntimeError('Variable "templateType" does not exist.', 136, $this->source); })()) == "html")) {
            // line 137
...
";
        ...
        // line 139
        echo "                                            ";
        if (((isset($context["templateType"]) || array_key_exists("templateType", $context) ? $context["templateType"] : (function () { throw new RuntimeError('Variable "templateType" does not exist.', 139, $this->source); })()) == "txt")) {
            // line 140
...
";
                ...
                <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"width:100%;\">
                  <tbody>
                    <tr>
                      <td style=\"direction:";
        // line 166
        echo twig_escape_filter($this->env, (isset($context["direction"]) || array_key_exists("direction", $context) ? $context["direction"] : (function () { throw new RuntimeError('Variable "direction" does not exist.', 166, $this->source); })()), "html", null, true);
        ...
        echo ";direction:";
        echo twig_escape_filter($this->env, (isset($context["direction"]) || array_key_exists("direction", $context) ? $context["direction"] : (function () { throw new RuntimeError('Variable "direction" does not exist.', 168, $this->source); })()), "html", null, true);
        echo ";display:inline-block;vertical-align:top;width:100%;\">
                          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"vertical-align:top;\" width=\"100%\">
                            <tbody>
                              <tr>
                                <td align=\"";
        // line 172
        echo twig_escape_filter($this->env, (isset($context["align_left"]) || array_key_exists("align_left", $context) ? $context["align_left"] : (function () { throw new RuntimeError('Variable "align_left" does not exist.', 172, $this->source); })()), "html", null, true);
        echo "\" style=\"font-size:0px;padding:10px 25px;word-break:break-word;\">
                                  <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:";
        // line 173
        echo twig_escape_filter($this->env, (isset($context["align_left"]) || array_key_exists("align_left", $context) ? $context["align_left"] : (function () { throw new RuntimeError('Variable "align_left" does not exist.', 173, $this->source); })()), "html", null, true);
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Follow your order and download your invoice on our store, go to the <a href=\"{history_url}\" target=\"_blank\">%order_history_label%</a> section of your customer account.", ["%order_history_label%" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Order history and details", [], "Shop.Theme.Customeraccount", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 173, $this->source); })()))], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 173, $this->source); })()));
        echo "</div>
                                </td>
                              </tr>
                            </tbody>
                ...
                <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"width:100%;\">
                  <tbody>
                    <tr>
                      <td style=\"direction:";
        // line 193
        echo twig_escape_filter($this->env, (isset($context["direction"]) || array_key_exists("direction", $context) ? $context["direction"] : (function () { throw new RuntimeError('Variable "direction" does not exist.', 193, $this->source); })()), "html", null, true);
        echo ";font-size:0px;padding:0 25px;text-align:center;\">
                        <!--[if mso | IE]><table role=\"presentation\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\"><tr><td class=\"\" style=\"vertical-align:top;width:554px;\" ><![endif]-->
                        <div class=\"mj-column-per-100 mj-outlook-group-fix\" style=\"font-size:0px;text-align:";
        // line 195
        echo twig_escape_filter($this->env, (isset($context["align_left"]) || array_key_exists("align_left", $context) ? $context["align_left"] : (function () { throw new RuntimeError('Variable "align_left" does not exist.', 195, $this->source); })()), "html", null, true);
        echo ";direction:";
        echo twig_escape_filter($this->env, (isset($context["direction"]) || array_key_exists("direction", $context) ? $context["direction"] : (function () { throw new RuntimeError('Variable "direction" does not exist.', 195, $this->source); })()), "html", null, true);
        echo ";display:inline-block;vertical-align:top;width:100%;\">
                          <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" role=\"presentation\" style=\"vertical-align:top;\" width=\"100%\">
                            <tbody>
                              <tr>
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("If you have a guest account, you can follow your order via the <a href=\"{guest_tracking_url}\" target=\"_blank\">%guest_tracking_label%</a> section on our shop.", ["%guest_tracking_label%" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Guest Tracking", [], "Shop.Theme.Customeraccount", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 200, $this->source); })()))], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 200, $this->source); })()));
        echo "</div>
                                </td>
                              </tr>
                            </tbody>
...
";
    ...
    {
        return array (  432 => 219,  422 => 218,  393 => 200,  389 => 199,  380 => 195,  375 => 193,  350 => 173,  346 => 172,  337 => 168,  332 => 166,  306 => 142,  302 => 140,  299 => 139,  295 => 137,  293 => 136,  289 => 135,  285 => 134,  276 => 130,  272 => 129,  259 => 121,  254 => 119,  225 => 95,  221 => 94,  208 => 86,  203 => 84,  170 => 56,  163 => 54,  134 => 30,  130 => 29,  119 => 23,  115 => 22,  101 => 13,  96 => 11,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:25px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;line-height:25px;text-align:{{ align_left }};color:#363A41;\">{{ 'Thank you for your order with the reference {order_name} from [1]{shop_name}[/1]'|trans({'[1]': '<span class=\"label\">', '[/1]': '</span>'}, 'Emails.Body', locale)|raw }}</div>
                                        </td>
                                      </tr>
                                      <!-- H2 TITLE ENDING -->
                                    </tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:16px;font-weight:600;line-height:25px;text-align:{{ align_left }};color:#363A41;\">{{ 'Product(s) to download'|trans({}, 'Emails.Body', locale)|raw }}</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:{{ align_left }};color:#363A41;\">{{ 'You have [1]{nbProducts}[/1] product(s) now available for download using the following link(s):'|trans({'[1]': '<span class=\"label\">', '[/1]': '</span>'}, 'Emails.Body', locale)|raw }}</div>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;line-height:25px;text-align:{{ align_left }};color:#363A41;\">
...
{% endblock %}
", "@MailThemes\\modern\\core\\download_product.html.twig", "C:\\xampp\\htdocs\\euromus\\mails\\themes\\modern\\core\\download_product.html.twig");
    }
}
