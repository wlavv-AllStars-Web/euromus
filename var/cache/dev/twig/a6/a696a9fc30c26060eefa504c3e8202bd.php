...
class __TwigTemplate_03d465f3a16158242c88bed8de98090c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Newsletter Confirmation", [], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 3, $this->source); })())), "html", null, true);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Hi,", [], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 23, $this->source); })()));
        echo "</div>
                                        </td>
                                      </tr>
                                      <!-- TITLE ENDING -->
        ...
        echo ";color:#363A41;\">";
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Thank you for subscribing to our newsletter.", [], "Emails.Body", (isset($context["locale"]) || array_key_exists("locale", $context) ? $context["locale"] : (function () { throw new RuntimeError('Variable "locale" does not exist.', 88, $this->source); })()));
        echo "</div>
                                        </td>
                                      </tr>
                                    </tbody>
...
";
    ...
    {
        return array (  253 => 111,  243 => 110,  210 => 88,  206 => 87,  193 => 79,  188 => 77,  155 => 49,  148 => 47,  119 => 23,  115 => 22,  101 => 13,  96 => 11,  89 => 6,  79 => 5,  60 => 3,  37 => 1,);
    }
                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:20px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:20px;font-weight:600;line-height:25px;text-align:{{ align_left }};color:#363A41;\">{{ 'Hi,'|trans({}, 'Emails.Body', locale)|raw }}</div>
                                        </td>
                                      </tr>
                                      <!-- TITLE ENDING -->
                                    </tbody>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align=\"{{ align_left }}\" style=\"font-size:0px;padding:10px 25px;word-break:break-word;\">
                                          <div style=\"font-family:Open sans, arial, sans-serif;font-size:14px;font-weight:600;line-height:25px;text-align:{{ align_left }};color:#363A41;\">{{ 'Thank you for subscribing to our newsletter.'|trans({}, 'Emails.Body', locale)|raw }}</div>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
...
{% endblock %}
", "@MailThemes\\modern\\modules\\ps_emailsubscription\\newsletter_conf.html.twig", "C:\\xampp\\htdocs\\euromus\\mails\\themes\\modern\\modules\\ps_emailsubscription\\newsletter_conf.html.twig");
    }
}
