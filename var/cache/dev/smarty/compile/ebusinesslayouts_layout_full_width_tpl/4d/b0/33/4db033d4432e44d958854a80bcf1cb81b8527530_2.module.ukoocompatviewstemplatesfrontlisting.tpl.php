<?php
/* Smarty version 4.3.4, created on 2024-06-20 17:31:36
  from 'module:ukoocompatviewstemplatesfrontlisting.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_66745968d4b0b0_52135655',
  ...
  'includes' => 
  array (
    'file:themes/ebusiness/templates/catalog/listing/product-list.tpl' => 4,
    'file:themes/classic/templates/_partials/pagination.tpl' => 1,
  ),
),false)) {
function content_66745968d4b0b0_52135655 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- begin C:\xampp\htdocs\euromus/themes/ebusiness/modules/ukoocompat/views/templates/front/listing.tpl --><?php $_smarty_tpl->_assignInScope('apply_filter_en', "Apply filters");
...
<?php if ((isset($_smarty_tpl->tpl_vars['search']->value->catalog_title)) && !empty($_smarty_tpl->tpl_vars['search']->value->catalog_title)) {?>
    ...
    <?php if ((isset($_smarty_tpl->tpl_vars['search']->value->tags)) && !empty($_smarty_tpl->tpl_vars['search']->value->tags)) {?>
        <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All your products for','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
    <?php } else { ?>
        <?php ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'All your products','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );
...
ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'for','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );
...
" class="btn btn-default">
                        <i class="icon-eye"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'See more','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );?>
...
" target="_blank" class="btn btn-default">
                        <i class="icon-download"></i> <?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'Download documentation','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );?>
...
<?php if ((isset($_smarty_tpl->tpl_vars['products']->value)) && !empty($_smarty_tpl->tpl_vars['products']->value)) {?>
	<?php if (!Context::getContext()->isMobile()) {?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['products']->value) {?>
            ...
            <?php $_smarty_tpl->_subTemplateRender("file:themes/ebusiness/templates/catalog/listing/product-list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('listing'=>$_smarty_tpl->tpl_vars['listing']->value,'products'=>$_smarty_tpl->tpl_vars['products']->value), 0, false);
?>
	...
	<?php } else { ?>
		...
		<?php $_smarty_tpl->_subTemplateRender("file:themes/ebusiness/templates/catalog/listing/product-list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('listing'=>$_smarty_tpl->tpl_vars['listing']->value), 0, true);
?>
		<div class="content_sortPagiBar">
...
?>
    ...
    <p class="alert alert-warning text-center"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'No result for your search.','d'=>'Modules.Ukoocompat.ListingEuro'),$_smarty_tpl ) );?>
</p>
<?php }?>
...
<?php echo '</script'; ?>
>
<!-- end C:\xampp\htdocs\euromus/themes/ebusiness/modules/ukoocompat/views/templates/front/listing.tpl --><?php }
}
