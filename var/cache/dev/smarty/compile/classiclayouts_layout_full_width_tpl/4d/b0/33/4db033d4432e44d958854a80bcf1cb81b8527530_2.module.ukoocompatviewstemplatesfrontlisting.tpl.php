...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_65a173b8529ae3_12175429',
  ...
  'includes' => 
  array (
    'file:themes/classic/templates/catalog/listing/product-list.tpl' => 1,
    'file:themes/classic/templates/_partials/pagination.tpl' => 2,
    'file:themes/theme1164/mobile/wm_top_filter.tpl' => 1,
  ),
),false)) {
function content_65a173b8529ae3_12175429 (Smarty_Internal_Template $_smarty_tpl) {
?><!-- begin C:\xampp\htdocs\euromus/modules/ukoocompat/views/templates/front/listing.tpl --><?php $_smarty_tpl->_assignInScope('apply_filter_en', "Apply filters");
...
?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['products']->value) {?>
            <div class="content_sortPagiBar">
                                <div class="bottom-pagination-content clearfix"> <?php $_smarty_tpl->_subTemplateRender("file:themes/classic/templates/_partials/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('paginationId'=>'top'), 0, false);
?> </div>
	...
	<?php } else { ?>
		...
		<?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./mobile/product-list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('listing'=>$_smarty_tpl->tpl_vars['products']->value), 0, true);
?>
		<div class="content_sortPagiBar">
			<div class="bottom-pagination-content clearfix">
				<?php $_smarty_tpl->_subTemplateRender(((string)$_smarty_tpl->tpl_vars['tpl_dir']->value)."./mobile/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('paginationId'=>'bottom'), 0, true);
?>
			</div>
		</div>
	<?php }
...
?>
            <?php if ($_smarty_tpl->tpl_vars['products']->value) {?><div class="top-pagination-content clearfix"> <?php $_smarty_tpl->_subTemplateRender("file:themes/classic/templates/_partials/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?> </div><?php }?>
        </div>
    <?php } else { ?>
        <div class="text-center" style="background-color: #333; color: white; text-transform: uppercase;padding: 10px;" onclick="$('#filters_holder').toggle('slow')">
...
<?php echo '</script'; ?>
>
<!-- end C:\xampp\htdocs\euromus/modules/ukoocompat/views/templates/front/listing.tpl --><?php }
}
