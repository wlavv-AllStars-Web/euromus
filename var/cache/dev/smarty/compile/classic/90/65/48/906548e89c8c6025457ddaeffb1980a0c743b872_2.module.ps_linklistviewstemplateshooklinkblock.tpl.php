...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_655df9ddd9adc0_09099355',
...
function content_655df9ddd9adc0_09099355 (Smarty_Internal_Template $_smarty_tpl) {
...
?>
    <div class="col-md-6 wrapper">
      <p style="border-bottom: 2px solid rgba(128, 128, 128, 0.5); color: White" class="h3 hidden-sm-down"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['linkBlock']->value['title'], ENT_QUOTES, 'UTF-8');?>
</p>
...
" data-toggle="collapse">
        <span style="color: White;" class="h3"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['linkBlock']->value['title'], ENT_QUOTES, 'UTF-8');?>
</span>
        <span class="float-xs-right">
          <span class="navbar-toggler collapse-icons">
            <i style="color: white" class="material-icons add">&#xE313;</i>
            <i style="color: white" class="material-icons remove">&#xE316;</i>
          </span>
        </span>
      </div>
...
<!-- end C:\xampp\htdocs\euromus/themes/classic/modules/ps_linklist/views/templates/hook/linkblock.tpl --><?php }
}
