...
class appAppKernelDevDebugContainer extends Container
{
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.1.3', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                38 => 'ps_metrics',
                39 => 'statsstock',
                40 => 'statsbestcategories',
                41 => 'statsbestcustomers',
                42 => 'statsbestmanufacturers',
                43 => 'statsbestsuppliers',
                44 => 'statsbestvouchers',
                ...
                59 => 'ps_googleanalytics',
                60 => 'gsitemap',
                61 => 'statsnewsletter',
                62 => 'pagesnotfound',
                63 => 'statsproduct',
                64 => 'ps_categoryproducts',
                ...
                70 => 'ps_imageslider',
                71 => 'autoupgrade',
                72 => 'ps_languageselector',
                73 => 'ukoocompat',
                74 => 'youtube_video',
                75 => 'wmmodule_homepage',
            ],
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQC4xj6ZxxTaBVlD'."\n".'qmd8F8d+spkR/1L0PACwmNT8yCCpl4Vu9kE8DOI74CkDpVSVNGGomF/JxlkpTQfv'."\n".'FhNc0zuatlTbfHWscHrfzNfZm+QXnh7HH+83QGYCx55Pb82fUbJn266scub5NMOd'."\n".'pQAsKRuKzcJJquoV94rLxFQ10mx+bvBc9TQ/6mrLaP5A4E3eKtTd5WdRJhmqItB6'."\n".'zJSzYBbJdWsk+GRf4Aw9U23jJyFG2mHi36wXt6IJabySGkFVzO50pCQXzIIxAzcs'."\n".'piP0BfMln2tG9VdROkjEnYoOXlHEsSa0+xl9kvygr+dHMkDvp/7GYjqed+MTQvDq'."\n".'gAGJQqkxAgMBAAECggEBAJwku0YMXGyZVIO//s948Nb6aiwxTZKjGhoiLOqo3CE0'."\n".'sEfCxgHPCWd72G0CS+YCa/yjN181xKcIN4otZ5Nr1dS5/B+2n2Jncw6o9kcoW6ox'."\n".'ruSq8eYI/6udsQSEAIl/6nmlxYhpWRKDKkOP6gNngaTcmDDUxBhoJdxoPpl1BsYX'."\n".'3lw2L/cZyAVddXAFJhQVpXqO+B3exbiaSQVbrJ9eZTc9oD3NvIG3spLPAhfiUeeF'."\n".'+NfN0+WL/Pynm7eW9Bd+l6YdiB7PxzGQQ2mNAI5VqZHbB+LPIGrDl6oJSLB5Zd+q'."\n".'yYirrzkXIq9khtkeCiT03Co5CsBT78w30kVro4nUHhkCgYEA3ILpzlk7+Lmn+WUJ'."\n".'jSP/dGwYWCEaggj8UJ8etSFQfrhbbjUVQb3RGMxslLK3OAH4ohzT0l15XAONHs1o'."\n".'I+lgvU5HxfDK21Akztel0uWPXlnE9ZW0EH2jG28ilCE4W21hqjpvn69XRDtMMzT/'."\n".'xVBQQ9oo21bSA0DaBRysI6tp+jcCgYEA1oL25r21k9OMLkc5hlJVC6GMew/zwsmY'."\n".'wjgy4SflsYnDBhnzmVb/jo78jRvko1dteXxe6GunLpWLADFr9P5b8YX3Rh+S9CG0'."\n".'pNc0SBePJTQdRhBCi/qOwyPByEa4tsJTgJFDW2LoZbBcHxnIfAiqPEzDSGbWRUsC'."\n".'1j088uRUI9cCgYBK08XBNvip015Tu9x8341NFW1BYqJbI+9y8Dv8XPyys56bDDpV'."\n".'X7M3xg7Gesq/n7OeV0ft57hJ6A6YOD2xif1A3/JtEePUfiKvafAkW6/F5ZJ3f8Bl'."\n".'pCyYH6NNPuSf6cMtf7znJBnp1nFqIv70FufVzo70t0Z2wif5ehxT0lQZCwKBgH5t'."\n".'nduNAFHqIvq7m9ng+KLsSgHV+xNZAiGmQcaWXzhuO3WDIiHENsbs20jHoc/rnWg2'."\n".'tzFBEb3RAaXRexFgQQxuqri3r0MYAoINHJFI4WNJ/d7ngnFB8ZZtoq7Jj+CXU+O4'."\n".'ufxIpTQZ55Gk/par/LmhfI9VnQAmH7vpR9zYWgbtAoGAC806s5gBaj1LCsvu2qd0'."\n".'5Sgy3L+Ww6pA33W+8WKzZp5unDGW6GDOL+uyYu3FY0ucvr+svfePPVN5OYMMFc77'."\n".'wVo+FVVKWu/uYwuTb4Eu15UZvVciIzpUm/x4xZP/8WBj9caKxcQHVTzvgUBTBA4o'."\n".'7uDDUPrt3dME91qoUzE3NEU='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'modules_translation_paths' => [
                ...
                9 => (\dirname(__DIR__, 4).'/modules/ps_featuredproducts/translations'),
                10 => (\dirname(__DIR__, 4).'/modules/ps_banner/translations'),
                11 => (\dirname(__DIR__, 4).'/modules/ps_customtext/translations'),
                ...
                20 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/gamification/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/ps_faviconnotificationbo/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/ps_accounts/translations'),
                ...
                29 => (\dirname(__DIR__, 4).'/modules/ps_checkout/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/psxmarketingwithgoogle/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/ps_metrics/translations'),
                33 => (\dirname(__DIR__, 4).'/modules/statsstock/translations'),
                34 => (\dirname(__DIR__, 4).'/modules/statsbestcategories/translations'),
                35 => (\dirname(__DIR__, 4).'/modules/statsbestcustomers/translations'),
                36 => (\dirname(__DIR__, 4).'/modules/statsbestmanufacturers/translations'),
                ...
                40 => (\dirname(__DIR__, 4).'/modules/statscarrier/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/ps_cashondelivery/translations'),
                42 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                43 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                44 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                45 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                46 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                47 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                ...
                51 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                52 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                53 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                54 => (\dirname(__DIR__, 4).'/modules/pagesnotfound/translations'),
                55 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                56 => (\dirname(__DIR__, 4).'/modules/ps_categoryproducts/translations'),
                57 => (\dirname(__DIR__, 4).'/modules/statspersonalinfos/translations'),
                ...
                61 => (\dirname(__DIR__, 4).'/modules/ps_themecusto/translations'),
                62 => (\dirname(__DIR__, 4).'/modules/ps_imageslider/translations'),
                63 => (\dirname(__DIR__, 4).'/modules/autoupgrade/translations'),
                64 => (\dirname(__DIR__, 4).'/modules/ps_languageselector/translations'),
                65 => (\dirname(__DIR__, 4).'/modules/ukoocompat/translations'),
                66 => (\dirname(__DIR__, 4).'/modules/wmmodule_homepage/translations'),
            ],
