...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('8.1.1', 'C:\\xampp\\htdocs\\euromus', true);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                65 => 'klaviyopsautomation',
                66 => 'ps_metrics',
                67 => 'ps_categoryproducts',
                68 => 'ps_facebook',
                69 => 'ps_cashondelivery',
                70 => 'ps_checkpayment',
                71 => 'ps_checkout',
                72 => 'ps_wirepayment',
                73 => 'mbeshipping',
                74 => 'ps_distributionapiclient',
                75 => 'autoupgrade',
                76 => 'ps_mainmenu',
                77 => 'ps_languageselector',
            ],
