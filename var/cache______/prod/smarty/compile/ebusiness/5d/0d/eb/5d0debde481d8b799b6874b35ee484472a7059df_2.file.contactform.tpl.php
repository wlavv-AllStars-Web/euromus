...
function content_667058a00637d5_69059638 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['contact']->value['message'], ENT_QUOTES, 'UTF-8');
            ...
            <span class="col-12" style="font-size: small;text-align:start;color:#333;"><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['l'][0], array( array('s'=>'(max 500 chars)'),$_smarty_tpl ) );?>
</span>
          </div>
